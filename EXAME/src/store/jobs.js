...
export const useJobsStore = defineStore({
  ...
  actions: {
    ...
    async getJobsDB() {
            try {
                const response = await fetch('http://daw.deei.fct.ualg.pt/~a76967/EXAME/api/jobs.php')
    ...
    async newJobDB(newJob) {
      ...
      try {
              ...
              const response = await fetch(`http://daw.deei.fct.ualg.pt/~a76967/EXAME/api/jobs.php?session_id=${userStore.user.session_id}`, {
              method: 'POST',
