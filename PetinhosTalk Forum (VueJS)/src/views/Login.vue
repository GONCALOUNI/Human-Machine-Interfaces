      ...
      <div class="container shadow" style="margin-top: -20px; margin-bottom: 8px;">
        <div class="content-container py-5 h-100" style="margin-top: -20px;">
          <div class="row d-flex justify-content-center align-items-center h-100">
            <h3 class="mb-5 text-uppercase text-center">Login here!</h3>
            <form @submit.prevent="submitForm" id="loginForm">
              ...
              <div class="form-group">
                ...
                <input v-model="user.email" type="text" id="form3Example1m" name="email" class="form-control form-control-lg" placeholder="someone@mail.com" style="max-width: 790px;">
              </div>
              <div class="form-group">
                <label for="form3Example97">Your password:</label>
                <input v-model="user.password" type="password" id="form3Example97" name="password" class="form-control form-control-lg" placeholder="Enter password" style="max-width: 790px;">
              </div>
              <div class="d-flex justify-content-center pt-3">
                <button type="submit" class="btn btn-warning btn-lg ms-2" style="margin-left: 375px;" :disabled="submitting">Login</button>
              </div>
              <p class="text-center my-3" style="margin-top: 20px">
                Not a member yet? <router-link to="/register">Register your free account here!</router-link>
              </p>
            </form>
          </div>
        </div>
